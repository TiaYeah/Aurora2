...
Page {
    ...
    Item {
        ...
        function getFieldModel() {
            ...
            localModel.push({pos: 2, length: 2, topY: 1, leftX: 2, visible: true, isRed: false})
            setMatrix(2, 2, 1, 2)
            localModel.push({pos: 2, length: 2, topY: 1, leftX: 3, visible: true, isRed: false})
            setMatrix(2, 2, 1, 3)
            localModel.push({pos: 2, length: 3, topY: 1, leftX: 4, visible: true, isRed: false})
            setMatrix(2, 3, 1, 4)
            localModel.push({pos: 2, length: 3, topY: 1, leftX: 5, visible: true, isRed: false})
            setMatrix(2, 3, 1, 5)
            localModel.push({pos: 2, length: 3, topY: 1, leftX: 6, visible: true, isRed: false})
            setMatrix(2, 3, 1, 6)
            localModel.push({pos: 2, length: 3, topY: 2, leftX: 1, visible: true, isRed: false})
            setMatrix(2, 3, 2, 1)
            localModel = pushInvisibleBlock(localModel, 6)
            localModel.push({pos: 1, length: 2, topY: 3, leftX: 2, visible: true, isRed: true})
            setMatrix(1, 2, 3, 2)
            localModel = pushInvisibleBlock(localModel, 6)
            localModel.push({pos: 2, length: 2, topY: 4, leftX: 3, visible: true, isRed: false})
            setMatrix(2, 2, 4, 3)
            localModel.push({pos: 1, length: 3, topY: 4, leftX: 4, visible: true, isRed: false})
            setMatrix(1, 3, 4, 4)
            localModel = pushInvisibleBlock(localModel, 2)
            localModel.push({pos: 1, length: 2, topY: 5, leftX: 1, visible: true, isRed: false})
            setMatrix(1, 2, 5, 1)
            localModel = pushInvisibleBlock(localModel, 11)
            return localModel
        }
